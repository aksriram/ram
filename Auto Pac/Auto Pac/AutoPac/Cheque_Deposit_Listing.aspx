<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.master" AutoEventWireup="true" CodeBehind="Cheque_Deposit_Listing.aspx.cs" Inherits="Auto_Pac.AutoPac.Cheque_Deposit_Listing" %>
                  ...
                  <div class="col-xs-6 col-sm-10" >
                   <asp:GridView ID="Gridview_access" runat="server" AutoGenerateColumns="false"  CellPadding="4"  ForeColor="#333333" GridLines="None" 
                      ...
                      <Columns>
                                      ...
                                      <asp:BoundField HeaderText="Finance Company" DataField="Finance_company" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="120px" />
                                      <asp:BoundField HeaderText="Cheque Number" DataField="Cheque_number" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="100px" />
