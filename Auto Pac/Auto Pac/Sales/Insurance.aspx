<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.master" AutoEventWireup="true" CodeBehind="Insurance.aspx.cs" Inherits="Auto_Pac.Sales.Insurance" %>
     ...
     <%-- <span style="color: brown; font-size: 23px; margin-left: 30px;"><b>Hire Purchase</b></span>--%>
       ...
       <br />
        <div style="padding-left:20px;">
            <div class="row equal">
                <div class=" col-sm-2">
                <asp:label id="lblinscompany" runat="server"   font-size="18px"  style="font-family: 'Times New Roman', Times, serif;">Insurance Comapny<span style="color:red;">*</span></asp:label>

            </div>
            <div class=" col-sm-3">
                 <asp:textbox id="txtinscompany" class="form-control" runat="server" placeholder=""></asp:textbox>
            </div>
            ...
            <div class="row equal">
                <div class=" col-sm-2">
                <asp:label id="lbladdress" runat="server"   font-size="18px"  style="font-family: 'Times New Roman', Times, serif;">Address</asp:label>

            </div>
            <div class=" col-sm-3">
                 <asp:textbox id="txtaddress" class="form-control" runat="server" placeholder="" Height="30px"></asp:textbox>
            </div>
                <div class=" col-sm-2">
                          ...
                          <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="40px">
                             <ItemTemplate>
                                <asp:CheckBox ID="chkCtrl" runat="server" Width="40px" />
                                      ...
                                      <asp:BoundField HeaderText="Insurance Comapany" DataField="Insurance_company" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="170px" />
