<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.master" AutoEventWireup="true" CodeBehind="Booking.aspx.cs" Inherits="Auto_Pac.Sales.Booking" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script  type="text/jscript" src="js/bootstrap-material-datetimepicker.js"></script>--%>
    <link href="Sales/css/bootstrap-datepicker.css" rel="stylesheet" />
    <script type="text/javascript" src="Sales/js/bootstrap-datepicker.js"></script>
    <script type="text/javascript" src="Sales/js/bootstrap-datepicker.min.js"></script>

    <script type="text/javascript">
        $('#txtbuyers_date').datepicker({
        });
    </script>
      <style type="text/css">
        .Background
            ...
            <div style="padding-left: 20px;">
        		...
        		--%>
                        ...
                        <div id="fragment-1" class="ui-tabs-panel">
                            ...
                            <div class="row equal">
                                <div class="col-xs-6 col-sm-2">
                                    <asp:Label ID="lblcnumber" runat="server" for="inputEmail3" Font-Size="18px" Text="Contract Number" Style="font-family: 'Times New Roman', Times, serif;"></asp:Label>

                                </div>
                                <div class="col-xs-6 col-sm-3">
                                    <asp:TextBox ID="txtcnumber" class="form-control" runat="server" placeholder=""></asp:TextBox>
                                </div>
                                <div class="col-xs-6 col-sm-1">

                                    <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="../Resources/images/Search_Icon.png" Width="30px" Height="30px" />
                                </div>
                                <div class="col-xs-6 col-sm-2">
                                    <asp:Label ID="lblcdate" runat="server" Font-Size="18px" Text="Contract Date" Style="font-family: 'Times New Roman', Times, serif;"></asp:Label>
                                </div>
                                <div class="col-xs-6 col-sm-3">
                                    <asp:TextBox ID="txtcdate" class="form-control" runat="server" placeholder="DD/MM/YYYY"></asp:TextBox>
                            ...
                            <div class="row equal">
                                ...
                                <div class="col-xs-6 col-sm-3">
                                    <asp:Label ID="Label1" runat="server" for="inputEmail3" Font-Size="18px" Text="" Style="font-family: 'Times New Roman', Times, serif;">Name as in NRIC/Passport <span style="color:red;">*</span></asp:Label>
                                </div>
                                <div class="col-xs-6 col-sm-3">
                            ...
                            <div class="row equal">
                                ...
                                <div class="col-xs-6 col-sm-3">
                                    <asp:Label ID="Label2" runat="server" for="inputEmail3" Font-Size="18px" Text="" Style="font-family: 'Times New Roman', Times, serif;">Mobile Number<span style="color:red;">*</span></asp:Label>
                                </div>
                                <div class="col-xs-6 col-sm-3">
                            ...
                            <div style="margin-left: 30px; border: solid thin #000000; border-radius: 05px;">
                                <span style="color: brown; font-size: 18px; margin-left: 10px;"><b>Mode Of Consent</b></span>
                                <br />
                                <br />
                                <div class="row equal" style="margin-left: 10px;">
                                    <div class="col-xs-6 col-sm-2">
                                        <asp:CheckBox ID="Checkdirectmail" runat="server" />
                                        <asp:Label ID="lbldirect" runat="server" Font-Size="18px" Text="Direct Mailer" Style="font-family: 'Times New Roman', Times, serif;"></asp:Label>
                                    ...
                                    <div class="col-xs-6 col-sm-2">
                                        ...
                                        <asp:Label ID="lblphone" runat="server" Font-Size="18px" Text="Phone Call" Style="font-family: 'Times New Roman', Times, serif;"></asp:Label>
                                ...
                                <div class="row eqaul" style="margin-left: 20px;">
                        ...
                        <div id="fragment-2" class="ui-tabs-panel ui-tabs-hide">
                            ...
                            <div class="row equal">
                                ...
                                <div class="col-xs-6 col-sm-3">
                                    <asp:TextBox ID="txtselprice" class="form-control" runat="server" placeholder="SGD"></asp:TextBox>
                                </div>
                ...
                <br />
                 ...
                 <div class="row equal">
                    ...
                    <div class="col-xs-6 col-sm-2">
                         <asp:Label ID="Label3" runat="server"   Font-Size="18px" Text="Deposit Date" Style="font-family:'Times New Roman', Times, serif; "></asp:Label>
                        </div>
                ...
                <br />
                    ...
                    <div class="col-xs-6 col-sm-2">
                      ...
                      <div class="col-xs-6 col-sm-3">
                          <asp:TextBox ID="txt_payment" class="form-control" runat="server" placeholder="EX: SGD"></asp:TextBox> 
                          </div>               
                            ...
                            <div class="row equal">
                                ...
                                <div class="col-xs-6 col-sm-2">
                                    <asp:Label ID="lblcoetop" runat="server" Font-Size="18px" Text="COE Top Up" Style="font-family: 'Times New Roman', Times, serif;"></asp:Label>
                                </div>

                                <div class="col-xs-6 col-sm-3">
                                    <asp:TextBox ID="txtcoetop" class="form-control" runat="server" placeholder=""></asp:TextBox>
                                </div>

                                <div class="col-xs-6 col-sm-2">
                                    <asp:Label ID="lblcoeoff" runat="server" Font-Size="18px" Text="COE Off Set" Style="font-family: 'Times New Roman', Times, serif;"></asp:Label>
                                </div>

                                <div class="col-xs-6 col-sm-3">
                                    <asp:TextBox ID="txtcoeoff" class="form-control" runat="server" placeholder=""></asp:TextBox>
                                </div>
                        ...
                        <div id="fragment-3" class="ui-tabs-panel ui-tabs-hide">
                            ...
                            <div class="row equal">
                                ...
                                <div class="col-xs-6 col-sm-2">
                                    <asp:Label ID="lblloandate" runat="server" Font-Size="18px" Text="Loan Date" Style="font-family: 'Times New Roman', Times, serif;"></asp:Label>
                                </div>
                            ...
                            <div class="row equal" style="margin-top: 10px;">
                                ...
                                <div class="col-xs-6 col-sm-2">
                                    <asp:Label ID="lbldealer" runat="server" Font-Size="18px" Text="Dealer Name" Style="font-family: 'Times New Roman', Times, serif;"> </asp:Label>
                                </div>
                            ...
                            <div class="row equal">
                                ...
                                <div class="col-xs-6 col-sm-2">
                                    <asp:Label ID="Label6" runat="server" Font-Size="18px" Text="Loan Status" Style="font-family: 'Times New Roman', Times, serif;"></asp:Label>
                                </div>
                                ...
                                <div class="col-xs-6 col-sm-3">
                                    <asp:Label ID="lblkocomo" runat="server" Font-Size="18px" Text="Kocomo OverTrade Subsidy" Style="font-family: 'Times New Roman', Times, serif;"></asp:Label>
                                </div>
                            ...
                            <div class="row equal">
                                ...
                                <div class="col-xs-6 col-sm-3">
                                    <asp:Label ID="lbltotal" runat="server" Font-Size="18px" Text="Total Purchase Price Of Used Vehicle" Style="font-family: 'Times New Roman', Times, serif;"></asp:Label>
                                </div>

                                <div class="col-xs-6 col-sm-2">
                                    <asp:TextBox ID="txttotal" class="form-control" runat="server" placeholder=""></asp:TextBox>
                                </div>
                        ...
                        <div id="fragment-4" class="ui-tabs-panel ui-tabs-hide">
                          ...
                          <span style="color: brown; font-size: 24px; margin-left: 0px;"><b>Details Of Accounts</b></span>
                            ...
                            <span style="color: brown; font-size: 20px; margin-left: 0px;"><b>Promotion</b></span>

                            <div class="row equal">

                                <div class="col-xs-6 col-sm-3">
                                    <asp:Label ID="Label_road" runat="server" Text="Additional 6 Months Road Tax:" ForeColor="Red" Font-Bold="true"></asp:Label>
                                </div>

                                <div class="col-xs-6 col-sm-3">
                                    <asp:ImageButton ID="imgroadtax" runat="server" ImageUrl="~/Resources/images/B_Yes.png" />
                                </div>
                            ...
                            <div class="row equal">
                                ...
                                <div class="col-xs-6 col-sm-2">
                                    <asp:Label ID="Label4" runat="server" Font-Size="18px" Text="Promotion (Free Items):" Style="font-family: 'Times New Roman', Times, serif;"></asp:Label>
                                </div>

                                <div class="col-xs-6 col-sm-3">
                                    <asp:DropDownList ID="ddl_promotion" class="form-control" runat="server">
                                        <asp:ListItem Text="--Please Select--" Value="0"></asp:ListItem>
                                    </asp:DropDownList>
                                </div>
                                  <div class="col-xs-6 col-sm-1">
                                ...
                                <div class="col-xs-6 col-sm-2">
                                    <asp:Label ID="Label_price" runat="server" Font-Size="18px" Text="Price:" placeholder="$500" Style="font-family: 'Times New Roman', Times, serif;"></asp:Label>
                                </div>

                                <div class="col-xs-6 col-sm-3">
                                    <asp:TextBox ID="Text_price" runat="server" class="form-control" placeholder="Ex: SGD"></asp:TextBox>
                                </div>
                            ...
                            <span style="color: skyblue; font-size: 20px; margin-left: 0px;"><b><u>Accessories</u></b></span>
                            <div class="row equal">

                                <div class="col-xs-6 col-sm-2">
                                    <asp:Label ID="Label_accessory" runat="server" Font-Size="18px" Text="Accessory:" Style="font-family: 'Times New Roman', Times, serif;"></asp:Label>
                                </div>

                                <div class="col-xs-6 col-sm-3">
                                    <asp:DropDownList ID="ddl_accessory" class="form-control" runat="server">
                                        <asp:ListItem Text="--Please Select--" Value="0"></asp:ListItem>
                                    </asp:DropDownList>
                                </div>
                                 <div class="col-xs-6 col-sm-1">
                                ...
                                <div class="col-xs-6 col-sm-2">
                                    <asp:Label ID="Label5" runat="server" Font-Size="18px" Text="Price:" placeholder="$500" Style="font-family: 'Times New Roman', Times, serif;"></asp:Label>
                                </div>
                                <div class="col-xs-6 col-sm-3">
                                    <asp:TextBox ID="Text_price1" runat="server" class="form-control" placeholder="Ex: SGD"></asp:TextBox>
                                </div>
                            ...
                            <div class="row equal">
                                ...
                                <div class="col-xs-6 col-sm-3">
                                    <asp:Label ID="Labeltotal" runat="server" Font-Size="18px" Text="Total Amount In Komoco's Account:" placeholder="$500" Style="font-family: 'Times New Roman', Times, serif;"></asp:Label>
                                </div>

                                <div class="col-xs-6 col-sm-3">
                                    <asp:Label ID="Label7" runat="server" Font-Size="17px" Text="$0.00" placeholder="$500" Style="font-family: 'Times New Roman', Times, serif;"></asp:Label>
                                </div>
                           ...
                           <span style="color: brown; font-size: 20px; margin-left: 0px;"><b>Buyer's Account</b></span>
                            ...
                            <div class="row equal">
                                <div class="col-xs-6 col-sm-2">
                                    <asp:Label ID="Label8" runat="server" Font-Size="18px" Text="Insurance Premium:$" Style="font-family: 'Times New Roman', Times, serif;"></asp:Label>
                                </div>

                                <div class="col-xs-6 col-sm-3">
                                    <asp:TextBox ID="Textinsurance" runat="server" class="form-control" placeholder=""></asp:TextBox>
                                </div>
                                <div class="col-xs-6 col-sm-1">
                                    <asp:ImageButton ID="Imginsurance" runat="server"  ImageUrl="../Resources/images/B_Add.png" Height="30px" Width="30px" />
                                </div>
                                <div class="col-xs-6 col-sm-3">
                                    <asp:Label ID="Labeladdroadtax" runat="server" Font-Size="18px" Text="Additional 6 Months Road Tax" Style="font-family: 'Times New Roman', Times, serif;"></asp:Label>
                                </div>

                                <div class="col-xs-6 col-sm-1">
                                    <asp:ImageButton ID="imgaddroadtax" runat="server" ImageUrl="~/Resources/images/B_Yes.png" />
                                </div>
                            ...
                            <div class="row equal">
                                ...
                                <div class="col-xs-6 col-sm-2">
                                    <asp:Label ID="Labelfirstinstall" runat="server" Font-Size="18px" Text="First Installment" Style="font-family: 'Times New Roman', Times, serif;"></asp:Label>
                                </div>

                                <div class="col-xs-6 col-sm-4">
                                    <asp:ImageButton ID="imgforstinstall" runat="server" ImageUrl="~/Resources/images/B_Yes.png" />
                                </div>
                                 <div class="col-xs-6 col-sm-3">
                                    <asp:Label ID="Label_adminfree" runat="server" Font-Size="18px" Text="Admin fee for overtrade:" Style="font-family: 'Times New Roman', Times, serif;"></asp:Label>
                                </div>

                                <div class="col-xs-6 col-sm-2">
                                    <asp:TextBox ID="Textadminfree" runat="server" class="form-control" placeholder=""></asp:TextBox>
                                </div>

                                <div class="col-xs-6 col-sm-1">
                                    <asp:ImageButton ID="imgadminfree" runat="server" Height="30px" Width="30px" ImageUrl="~/Resources/images/B_Add.png" />
                                </div>
                            ...
                            <div class="row equal">
                                ...
                                <div class="col-xs-6 col-sm-2">
                                    <asp:Label ID="Label_accessory2" runat="server" Font-Size="18px" class="col-sm-3 control-label" Text="Accessorry:" Style="font-family: 'Times New Roman', Times, serif;"></asp:Label>

                                </div>

                                <div class="col-xs-6 col-sm-3">
                                    <asp:DropDownList ID="ddl_accessory2" class="form-control" runat="server">
                                        <asp:ListItem Text="--Please Select--" Value="0"></asp:ListItem>
                                    </asp:DropDownList>
                                </div>
                                 <div class="col-xs-6 col-sm-1">
                                ...
                                <div class="col-xs-6 col-sm-2">
                                    <asp:Label ID="Labelprice2" runat="server" Font-Size="18px" Text="Price:" placeholder="$500" Style="font-family: 'Times New Roman', Times, serif;"></asp:Label>
                                </div>

                                <div class="col-xs-6 col-sm-3">
                                    <asp:TextBox ID="Text_price2" runat="server" class="form-control" placeholder="Ex: SGD"></asp:TextBox>
                                </div>
                            ...
                            <div class="row equal">
                                ...
                                <div class="col-xs-6 col-sm-3">
                                    <asp:Label ID="Label_totalamount" runat="server" Font-Size="18px" Text="Total Amount In Buyer's Account:" placeholder="$500" Style="font-family: 'Times New Roman', Times, serif;"></asp:Label>
                                </div>
                                <div class="col-xs-6 col-sm-3">
                                    <asp:Label ID="Label10" runat="server" Font-Size="15px" Text="$0.00" placeholder="" Style="font-family: 'Times New Roman', Times, serif;"></asp:Label>
                                </div>
                            ...
                            <div class="row equal">
                                ...
                                <div class="col-xs-6 col-sm-2">
                                    <asp:Label ID="Labelinsurance2" runat="server" Font-Size="18px" Text="Insurance Premium:" Style="font-family: 'Times New Roman', Times, serif;"></asp:Label>
                                </div>

                                <div class="col-xs-6 col-sm-3">
                                    <asp:TextBox ID="Textinsurance2" runat="server" class="form-control" placeholder=""></asp:TextBox>
                                </div>

                                <div class="col-xs-6 col-sm-1">
                                    <asp:ImageButton ID="imginsurance2" runat="server" Height="30px" Width="30px" ImageUrl="~/Resources/images/B_Add.png" />
                                </div>

                                  <div class="col-xs-6 col-sm-3">
                                    <asp:Label ID="Labeladdroad2" runat="server" Font-Size="18px" Text="Additional 6 Months Road Tax" Style="font-family: 'Times New Roman', Times, serif;"></asp:Label>
                                </div>
                                <div class="col-xs-6 col-sm-1">
                                    <asp:ImageButton ID="imgaddroad2" runat="server"  ImageUrl="~/Resources/images/B_Yes.png" />
                                </div>
                            ...
                            <div class="row equal">
                                ...
                                <div class="col-xs-6 col-sm-3">
                                    <asp:Label ID="Labeladminfee2" runat="server" Font-Size="18px" Text="Admin fee for overtrade: " Style="font-family: 'Times New Roman', Times, serif;"></asp:Label>
                                </div>

                                <div class="col-xs-6 col-sm-2">
                                    <asp:TextBox ID="Textadmingee2" runat="server" class="form-control" placeholder="Ex: SGD"></asp:TextBox>
                                    <%-- <asp:TextBox ID="Textadmingee2" runat="server"  placeholder="Ex: 2500:00"></asp:TextBox>--%>
                                </div>
                                <div class="col-xs-6 col-sm-1">

                                    <asp:ImageButton ID="imgadminfee2" runat="server" Height="30px" Width="30px" ImageUrl="~/Resources/images/B_Add.png" />
                                </div>

                                <div class="col-xs-6 col-sm-2">
                                    <asp:Label ID="Label_coe" runat="server" Font-Size="18px" Text="COE Top Up :" Style="font-family: 'Times New Roman', Times, serif;"></asp:Label>
                                </div>

                                <div class="col-xs-6 col-sm-2">
                                    <asp:TextBox ID="Text_coe" runat="server" class="form-control" placeholder=""></asp:TextBox>
                                    <%--  <asp:TextBox ID="Text_coe" runat="server" placeholder="Ex: 2500:00"></asp:TextBox>--%>
                                </div>
                                <div class="col-xs-6 col-sm-1">
                                    <asp:ImageButton ID="img_coe" runat="server" Height="30px" Width="30px" ImageUrl="~/Resources/images/B_Add.png" />
                                </div>
                            ...
                            <div class="row equal">
                                ...
                                <div class="col-xs-6 col-sm-3">
                                    <asp:Label ID="Label_accessory3" runat="server" Font-Size="18px" Text="Accessory:" Style="font-family: 'Times New Roman', Times, serif;"></asp:Label>
                                </div>

                                <div class="col-xs-6 col-sm-2">
                                    <asp:DropDownList ID="ddl_accessory3" class="form-control" runat="server">
                                        <asp:ListItem Text="--Please Select--" Value="0"></asp:ListItem>
                                    </asp:DropDownList>
                                </div>
                                <div class="col-xs-6 col-sm-1"></div>
                                <div class="col-xs-6 col-sm-2">
                                    <asp:Label ID="Label_price3" runat="server" Font-Size="18px" Text="Price:" Style="font-family: 'Times New Roman', Times, serif;"></asp:Label>
                                </div>
                                <div class="col-xs-6 col-sm-2">
                                    <asp:TextBox ID="Text_price3" runat="server" class="form-control" placeholder="Ex: SGD"></asp:TextBox>
                                </div>
                            ...
                            <div class="row equal">
                                ...
                                <div class="col-xs-6 col-sm-3">
                                    <asp:Label ID="Label_buyeramount" runat="server" Font-Size="18px" Text="Total Amount In Buyer's Account:" placeholder="$500" Style="font-family: 'Times New Roman', Times, serif;"></asp:Label>
                                </div>

                                <div class="col-xs-6 col-sm-2">
                                    <asp:Label ID="Label12" runat="server" Font-Size="18px" Text="$0.00" placeholder="" Style="font-family: 'Times New Roman', Times, serif;"></asp:Label>
                                </div>
                            </div>
                            ...
                            <div class="row equal">
                                ...
                                <div class="col-xs-6 col-sm-4">
                                    <asp:ImageButton ID="ImageButton4" runat="server" ImageUrl="~/Resources/images/Buyer_Order.png" />

                                    <asp:ImageButton ID="ImageButton5" runat="server" ImageUrl="~/Resources/images/B_Clear.png" Style="margin-left:10px;" />
                                </div>
                            </div>
